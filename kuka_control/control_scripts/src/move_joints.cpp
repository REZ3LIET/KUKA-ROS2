...
#include "control_actions/action/move_j.hpp"
#include "control_actions/msg/joint_pose.hpp"
...
{
public:
    using MoveJ = control_actions::action::MoveJ;
...
private:
    ...
    {
        auto JointGoal = control_actions::msg::JointPose();
        JointGoal =  goal->goal;
