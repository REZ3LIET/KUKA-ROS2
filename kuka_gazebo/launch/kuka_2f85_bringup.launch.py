...
def generate_launch_description():
    ...
    robot_name = LaunchConfiguration('robot_name', default='kuka_2f85_arm')
    ...
    robotiq_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'active', 'robotiq_2f85_controller', '-c', PathJoinSubstitution([namespace, "/controller_manager"])],
        output="screen"
    )
    ...
    return LaunchDescription([
        DeclareLaunchArgument('ign_gz', default_value=ign_gz),
